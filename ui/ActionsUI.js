...
class ActionsUI extends React.Component {
  constructor(props) {
    super(props);
...
ActionsUI.propTypes = propTypes;
ActionsUI.defaultProps = defaultProps;
ActionsUI.contextTypes = contextTypes;
