...
class MessageContainerUI extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderLoadEarlier() {
    if (this.props.loadEarlier === true) {
      ...
      return (
        <LoadEarlierUI {...loadEarlierProps} />
      );
    }
    return null;
  }
...
MessageContainerUI.propTypes = propTypes;
MessageContainerUI.defaultProps = defaultProps;

export default MessageContainerUI;